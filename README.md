...
```
Please edit the location of the csv ( *.gz format) file and archive folder with your local folder.
...
2. GET http://localhost:8090/myfin/api/trade-metrics/2018-05-28 ( here date is mandatory and user can edit the date)
